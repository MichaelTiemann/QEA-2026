function F=QEA_ReturnFn(h,ks_out,aprime,pvprime,a,pv,ks_balance,z1,z2,w,sigma,psi,eta,agej,Jr,pension,r,ks_employee,kappa_j,wg1,wg2,wg3,beta,sj,energy_shock)
...
% Median Kiwi income is roughly $120K/hh, so $20K 5kW system with 10kWh
% battery is 1/6th income.  One fifth share of that is 1/30th income.
pv_cost_delta=w*(pv-pvprime)/single(30);

% Calculate energy expense/income/investment
energy_cost=0.3*(logical(energy_shock)*(z2-single_1)+logical(~energy_shock));
if pv>5
