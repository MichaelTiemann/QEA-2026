        ...
        for pv_regime=pv_regimes
            ...
            for ks_regime=1:length(ks_legends)
                ...
                for pension_regime=1:length(pension_schemes)
                    ...
                    VAgeConditionalStats.title=sprintf("Life Cycle Profile: Assets Allocations %s; Pension %d", shock_titles{shock_regime}, round(100*pension_schemes(pension_regime)));
                    VAgeConditionalStats.legend={sprintf("KiwiSaver Balance (ks) %s", ks_legends{ks_regime}), ...
                        'Solar PV Shares (pv)', ...
                        'Assets (a)', ...
                        'Leisure (leisure_h)', ...
                        'Location','northeast'};
                    ...
                    if shock_regime==2 && pension_regime==3
                        ...
                        hold on
                        plot(1:1:Params.J,VAgeConditionalStats.assets.Mean)
                        plot(1:1:Params.J,VAgeConditionalStats.assets.Minimum)
                        plot(1:1:Params.J,VAgeConditionalStats.assets.Maximum)
                        plot(1:1:Params.J,VAgeConditionalStats.ks.Mean,'-o')
                        plot(1:1:Params.J,VAgeConditionalStats.ks.Minimum,'-d')
                        hold off
                        ...
                        VAgeConditionalStats2=LifeCycleProfiles_FHorz_Case1(VStationaryDist,VPolicy,FnsToEvaluate2,Params,[],n_d,n_a,n_z,N_j,d_grid,a_grid,z_gridvals_J,simoptions_this_shock);
                        ...
                        hold on
                        plot(1:1:Params.J,VAgeConditionalStats2.income.Mean)
                        plot(1:1:Params.J,VAgeConditionalStats2.income.QuantileMeans(Params.Q_min,:))
                        plot(1:1:Params.J,VAgeConditionalStats2.income.QuantileMeans(Params.Q_max,:))
                        plot(1:1:Params.J,VAgeConditionalStats2.expenses.Mean)
                        plot(1:1:Params.J,VAgeConditionalStats2.expenses.QuantileMeans(Params.Q_min,:))
                        plot(1:1:Params.J,VAgeConditionalStats2.expenses.QuantileMeans(Params.Q_max,:))
                        ...
                        hold on
                        plot(1:1:Params.J,VAgeConditionalStats2.leisure_h.Mean,'-o')
                        plot(1:1:Params.J,VAgeConditionalStats2.leisure_h.Minimum,'-d')
                        plot(1:1:Params.J,VAgeConditionalStats2.leisure_h.Maximum,'-p')
                        hold off
                    end
